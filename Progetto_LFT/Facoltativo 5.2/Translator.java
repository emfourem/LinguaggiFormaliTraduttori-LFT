	...
	*/
     ...
     private void stat(int lnext_ered_stat) {
		switch(look.tag){
			...
			case Tag.ASSIGN:
             ...
             case Tag.PRINT:
                //non stampo la print perchè viene stampata alla fine
				match(Tag.PRINT);
				match('(');
	...
	private void bexpr(int ltrue,int lfalse) {
        ...
        switch(look.tag){
            ...
            case Tag.AND:
            //se una è falsa esco direttamente
            ...
            case Tag.OR:
            //se la prima è falsa emetto l'etichetta e controllo la seconda
